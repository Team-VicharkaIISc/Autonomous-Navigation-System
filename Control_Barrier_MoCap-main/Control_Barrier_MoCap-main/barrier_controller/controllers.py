...
print(create_hybrid_unicycle_pose_controller(position_error=0, rotation_error= 0, position_epsilon=-1000, velocity_magnitude_limit=0.001)(states=states, poses=poses, input_approach_state=input_approach_state))